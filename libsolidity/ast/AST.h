...
{
  public:
	SourceUnit(SourceLocation const &_location, std::vector<ASTPointer<ASTNode>> const &_nodes) : ASTNode(_location), m_nodes(_nodes) {}
...
class Declaration : public ASTNode
{
  public:
	...
	Declaration(
		...
		Visibility _visibility = Visibility::Default) : ASTNode(_location), m_name(_name), m_visibility(_visibility), m_scope(nullptr) {}
...
class PragmaDirective : public ASTNode
{
  public:
	PragmaDirective(
		...
		std::vector<ASTString> const &_literals) : ASTNode(_location), m_tokens(_tokens), m_literals(_literals)
	{
	}
...
class ImportDirective : public Declaration
{
  public:
	ImportDirective(
		...
		std::vector<std::pair<ASTPointer<Identifier>, ASTPointer<ASTString>>> &&_symbolAliases) : Declaration(_location, _unitAlias),
																								  m_path(_path),
...
class ContractDefinition : public Declaration, public Documented
{
  public:
	...
	ContractDefinition(
		...
		ContractKind _contractKind = ContractKind::Contract) : Declaration(_location, _name),
	...
	std::vector<ASTPointer<ASTNode>> &subNodesByRef() const { return const_cast<std::vector<ASTPointer<ASTNode>> &>(m_subNodes); }
...
class InheritanceSpecifier : public ASTNode
{
  public:
	InheritanceSpecifier(
		...
		std::vector<ASTPointer<Expression>> _arguments) : ASTNode(_location), m_baseName(_baseName), m_arguments(_arguments) {}
...
class UsingForDirective : public ASTNode
{
  public:
	UsingForDirective(
		...
		ASTPointer<TypeName> const &_typeName) : ASTNode(_location), m_libraryName(_libraryName), m_typeName(_typeName) {}
...
class StructDefinition : public Declaration
{
  public:
	StructDefinition(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_name,
		std::vector<ASTPointer<VariableDeclaration>> const &_members) : Declaration(_location, _name), m_members(_members) {}
...
class EnumDefinition : public Declaration
{
  public:
	EnumDefinition(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_name,
		std::vector<ASTPointer<EnumValue>> const &_members) : Declaration(_location, _name), m_members(_members) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
{
  public:
	EnumValue(SourceLocation const &_location, ASTPointer<ASTString> const &_name) : Declaration(_location, _name) {}
...
class ParameterList : public ASTNode
{
  public:
	ParameterList(
		SourceLocation const &_location,
		std::vector<ASTPointer<VariableDeclaration>> const &_parameters) : ASTNode(_location), m_parameters(_parameters) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class CallableDeclaration : public Declaration, public VariableScope
{
  public:
	CallableDeclaration(
		...
		ASTPointer<ParameterList> const &_returnParameters = ASTPointer<ParameterList>()) : Declaration(_location, _name, _visibility),
...
class FunctionDefinition : public CallableDeclaration, public Documented, public ImplementationOptional
{
  public:
	FunctionDefinition(
		...
		ASTPointer<Block> const &_body) : CallableDeclaration(_location, _name, _visibility, _parameters, _returnParameters),
										  Documented(_documentation),
...
class VariableDeclaration : public Declaration
{
  public:
	...
	VariableDeclaration(
		...
		Location _referenceLocation = Location::Default) : Declaration(_sourceLocation, _name, _visibility),
														   m_typeName(_type),
														   m_value(_value),
...
class ModifierDefinition : public CallableDeclaration, public Documented
{
  public:
	ModifierDefinition(
		...
		ASTPointer<ASTString> const &_documentation,
		ASTPointer<ParameterList> const &_parameters,
		ASTPointer<Block> const &_body) : CallableDeclaration(_location, _name, Visibility::Internal, _parameters),
										  Documented(_documentation),
										  m_body(_body)
	{
	}
...
class ModifierInvocation : public ASTNode
{
  public:
	ModifierInvocation(
		...
		std::vector<ASTPointer<Expression>> _arguments) : ASTNode(_location), m_modifierName(_name), m_arguments(_arguments) {}
...
class EventDefinition : public CallableDeclaration, public Documented
{
  public:
	EventDefinition(
		...
		ASTPointer<ASTString> const &_documentation,
		ASTPointer<ParameterList> const &_parameters,
		bool _anonymous = false) : CallableDeclaration(_location, _name, Visibility::Default, _parameters),
								   Documented(_documentation),
...
{
  public:
	MagicVariableDeclaration(ASTString const &_name, std::shared_ptr<Type const> const &_type) : Declaration(SourceLocation(), std::make_shared<ASTString>(_name)), m_type(_type) {}
...
{
  public:
	ElementaryTypeName(SourceLocation const &_location, ElementaryTypeNameToken const &_elem) : TypeName(_location), m_type(_elem)
	{
	}
...
{
  public:
	UserDefinedTypeName(SourceLocation const &_location, std::vector<ASTString> const &_namePath) : TypeName(_location), m_namePath(_namePath) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class FunctionTypeName : public TypeName
{
  public:
	FunctionTypeName(
		...
		Declaration::Visibility _visibility,
		StateMutability _stateMutability) : TypeName(_location), m_parameterTypes(_parameterTypes), m_returnTypes(_returnTypes),
...
class Mapping : public TypeName
{
  public:
	Mapping(
		...
		ASTPointer<TypeName> const &_valueType) : TypeName(_location), m_keyType(_keyType), m_valueType(_valueType) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class ArrayTypeName : public TypeName
{
  public:
	ArrayTypeName(
		...
		ASTPointer<Expression> const &_length) : TypeName(_location), m_baseType(_baseType), m_length(_length) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class Statement : public ASTNode, public Documented
{
  public:
	explicit Statement(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_docString) : ASTNode(_location), Documented(_docString) {}
...
class InlineAssembly : public Statement
{
  public:
	InlineAssembly(
		...
		std::shared_ptr<assembly::Block> const &_operations) : Statement(_location, _docString), m_operations(_operations) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class Block : public Statement
{
  public:
	Block(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_docString,
		std::vector<ASTPointer<Statement>> const &_statements) : Statement(_location, _docString), m_statements(_statements) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;

	std::vector<ASTPointer<Statement>> const &statements() const { return m_statements; }
	std::vector<ASTPointer<Statement>> &statementsRef() const { return const_cast<std::vector<ASTPointer<Statement>> &>(m_statements); }
...
class PlaceholderStatement : public Statement
{
  public:
	explicit PlaceholderStatement(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_docString) : Statement(_location, _docString) {}
...
class IfStatement : public Statement
{
  public:
	IfStatement(
		...
		ASTPointer<Statement> const &_falseBody) : Statement(_location, _docString),
...
class WhileStatement : public BreakableStatement
{
  public:
	WhileStatement(
		...
		bool _isDoWhile) : BreakableStatement(_location, _docString), m_condition(_condition), m_body(_body),
...
class ForStatement : public BreakableStatement
{
  public:
	ForStatement(
		...
		ASTPointer<Statement> const &_body) : BreakableStatement(_location, _docString),
...
{
  public:
	explicit Continue(SourceLocation const &_location, ASTPointer<ASTString> const &_docString) : Statement(_location, _docString) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
};
...
{
  public:
	explicit Break(SourceLocation const &_location, ASTPointer<ASTString> const &_docString) : Statement(_location, _docString) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
};
...
class Return : public Statement
{
  public:
	Return(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_docString,
		ASTPointer<Expression> _expression) : Statement(_location, _docString), m_expression(_expression) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
{
  public:
	explicit Throw(SourceLocation const &_location, ASTPointer<ASTString> const &_docString) : Statement(_location, _docString) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
};
...
class VariableDeclarationStatement : public Statement
{
  public:
	VariableDeclarationStatement(
		...
		ASTPointer<Expression> const &_initialValue) : Statement(_location, _docString), m_variables(_variables), m_initialValue(_initialValue) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class Conditional : public Expression
{
  public:
	Conditional(
		...
		ASTPointer<Expression> const &_falseExpression) : Expression(_location),
														  m_condition(_condition),
...
class Assignment : public Expression
{
  public:
	Assignment(
		...
		ASTPointer<Expression> const &_rightHandSide) : Expression(_location),
...
class TupleExpression : public Expression
{
  public:
	TupleExpression(
		...
		bool _isArray) : Expression(_location),
...
class UnaryOperation : public Expression
{
  public:
	UnaryOperation(
		...
		bool _isPrefix) : Expression(_location),
...
class BinaryOperation : public Expression
{
  public:
	BinaryOperation(
		...
		Token::Value _operator,
		ASTPointer<Expression> const &_right) : Expression(_location), m_left(_left), m_operator(_operator), m_right(_right)
	{
...
class FunctionCall : public Expression
{
  public:
	FunctionCall(
		...
		std::vector<ASTPointer<ASTString>> const &_names) : Expression(_location), m_expression(_expression), m_arguments(_arguments), m_names(_names) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class NewExpression : public Expression
{
  public:
	NewExpression(
		SourceLocation const &_location,
		ASTPointer<TypeName> const &_typeName) : Expression(_location), m_typeName(_typeName) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class MemberAccess : public Expression
{
  public:
	MemberAccess(
		...
		ASTPointer<ASTString> const &_memberName) : Expression(_location), m_expression(_expression), m_memberName(_memberName) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
	Expression const &expression() const { return *m_expression; }
...
class IndexAccess : public Expression
{
  public:
	IndexAccess(
		...
		ASTPointer<Expression> const &_index) : Expression(_location), m_base(_base), m_index(_index) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class Identifier : public PrimaryExpression
{
  public:
	Identifier(
		SourceLocation const &_location,
		ASTPointer<ASTString> const &_name) : PrimaryExpression(_location), m_name(_name) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
{
  public:
	ElementaryTypeNameExpression(SourceLocation const &_location, ElementaryTypeNameToken const &_type) : PrimaryExpression(_location), m_typeToken(_type)
	{
	}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
...
class Literal : public PrimaryExpression
{
  public:
	...
	Literal(
		...
		SubDenomination _sub = SubDenomination::None) : PrimaryExpression(_location), m_token(_token), m_value(_value), m_subDenomination(_sub) {}
	virtual void accept(ASTVisitor &_visitor) override;
	virtual void accept(ASTConstVisitor &_visitor) const override;
