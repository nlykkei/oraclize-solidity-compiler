/** 
 *  @file    LocalKDSUInt8.sol
 *  @author  Nicolas Lykke Iversen (nlykkei)
 *  @date    1/1/2018  
 *  @version 1.0 
 *  
 *  @brief Oraclize, Local "kds" benchmark (uint8). 
 *
 *  @section DESCRIPTION
 *  
 *  Contract for benchmarking local "kds" (uint8).
 */

pragma solidity ^0.4.11;

contract LocalKDSUInt8 {
            
    //event LogEvent(string msg, uint[] res);

    function LocalKDSUInt8() public payable {}    
    ...
    function kdset(uint8[] m, uint k) private constant returns(uint[]) {
